...
| "I didn't find anything, but I should write *something* so the review doesn't look empty." | Invented findings are worse than none; a documented clean pass, backed by the checklist you actually ran, is a valid outcome. | Do not invent findings to avoid a clean report |
